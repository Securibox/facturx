...
{
    internal class BasicWLInvoiceBuilder : InvoiceBuilder
    {
        private Models.BasicWL.Invoice invoice;

        internal BasicWLInvoiceBuilder(XmlDocument xmlDocument)
            : base(FacturXConformanceLevelType.BasicWL, xmlDocument)
        {
            invoice = new Models.BasicWL.Invoice();
        }
        ...
        protected override void BuildStakeHolders()
        {
            ...
            {
                Seller =
                    TradePartyFactory.ConvertActor(TradePartyType.Seller) as Models.BasicWL.Seller,
                Buyer =
                    TradePartyFactory.ConvertActor(TradePartyType.Buyer) as Models.BasicWL.Buyer,
        ...
        {
            invoice.Totals =
                GetTotals(invoice.DirectDebit.InvoiceCurrencyCode) as Models.BasicWL.Totals;
        }

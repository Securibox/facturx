...
namespace Securibox.FacturX.Models.Extended
{
    public class LineAdditionalDocument : IReference
    {
        ...
        internal void AddExternalLocation(string? externalLocation) =>
        ...
        internal void AddAttachedDocument(Attachment? attachedDocument) =>
            AttachedDocument = attachedDocument;

        internal void AddReferenceTypeCode(string? referenceTypeCode) =>

...
namespace Securibox.FacturX.Tests.FacturxImporterTests
{
    ...
    {
        private readonly string _mainDir = $"{System.IO.Directory.GetCurrentDirectory()?.Split("\\bin")?.ElementAtOrDefault(0)}\\Invoices\\BASIC\\";
        ...
        public void ExtractData_Facture_F20220023_Basic_SUCCESS()
        {
            ...
            Assert.IsTrue(line1.SpecifiedLineTradeSettlement.SpecifiedTradeAllowanceCharge.ElementAt(1).ChargeIndicator.Indicator);
            Assert.AreEqual(1.00, line1.SpecifiedLineTradeSettlement.SpecifiedTradeAllowanceCharge.ElementAt(1).ActualAmount.Value);
            Assert.IsNull(line1.SpecifiedLineTradeSettlement.SpecifiedTradeAllowanceCharge.ElementAt(1).ReasonCode);
            Assert.AreEqual("FRAIS PALETTE", line1.SpecifiedLineTradeSettlement.SpecifiedTradeAllowanceCharge.ElementAt(1).Reason);
            ...
            Assert.AreEqual(100.00, allowanceChargeList.ElementAt(0).BasisAmount.Value);
            Assert.AreEqual(5.00, allowanceChargeList.ElementAt(0).ActualAmount.Value);
            Assert.AreEqual("95", allowanceChargeList.ElementAt(0).ReasonCode);
            ...
            Assert.AreEqual(1.00, allowanceChargeList.ElementAt(1).CalculationPercent);
            Assert.AreEqual(100.00, allowanceChargeList.ElementAt(1).BasisAmount.Value);
            Assert.AreEqual(1.00, allowanceChargeList.ElementAt(1).ActualAmount.Value);
            ...
            Assert.IsFalse(allowanceChargeList.ElementAt(2).ChargeIndicator.Indicator);
            Assert.AreEqual(1.00, allowanceChargeList.ElementAt(2).CalculationPercent);
            Assert.AreEqual(100.00, allowanceChargeList.ElementAt(2).BasisAmount.Value);
            Assert.AreEqual("100", allowanceChargeList.ElementAt(2).ReasonCode);
            Assert.AreEqual("REMISE COMMERCIALE", allowanceChargeList.ElementAt(2).Reason);
            ...
            Assert.IsFalse(allowanceChargeList.ElementAt(3).ChargeIndicator.Indicator);
            Assert.AreEqual(2.00, allowanceChargeList.ElementAt(3).CalculationPercent);
            Assert.AreEqual(100.00, allowanceChargeList.ElementAt(3).BasisAmount.Value);
            Assert.AreEqual(2.00, allowanceChargeList.ElementAt(3).ActualAmount.Value);
            Assert.IsNull(allowanceChargeList.ElementAt(3).ReasonCode);
            Assert.AreEqual("REMISE COMMERCIALE", allowanceChargeList.ElementAt(3).Reason);
            ...
            Assert.IsTrue(allowanceChargeList.ElementAt(4).ChargeIndicator.Indicator);
            Assert.AreEqual(10.00, allowanceChargeList.ElementAt(4).CalculationPercent);
            Assert.AreEqual(100.00, allowanceChargeList.ElementAt(4).BasisAmount.Value);
            Assert.AreEqual(10.00, allowanceChargeList.ElementAt(4).ActualAmount.Value);
            Assert.AreEqual("FC", allowanceChargeList.ElementAt(4).ReasonCode);
            Assert.AreEqual("FRAIS DEPLACEMENT", allowanceChargeList.ElementAt(4).Reason);
            Assert.AreEqual("VAT", allowanceChargeList.ElementAt(4).CategoryTradeTax.TypeCode);
            Assert.AreEqual("S", allowanceChargeList.ElementAt(4).CategoryTradeTax.CategoryCode);
            Assert.AreEqual(20.00, allowanceChargeList.ElementAt(4).CategoryTradeTax.RateApplicablePercent);

            Assert.IsTrue(allowanceChargeList.ElementAt(5).ChargeIndicator.Indicator);
            Assert.AreEqual(1.00, allowanceChargeList.ElementAt(5).CalculationPercent);
            Assert.AreEqual(100.00, allowanceChargeList.ElementAt(5).BasisAmount.Value);
            Assert.AreEqual(1.00, allowanceChargeList.ElementAt(5).ActualAmount.Value);
            Assert.AreEqual("ADR", allowanceChargeList.ElementAt(5).ReasonCode);
            Assert.AreEqual("FRAIS DEPLACEMENT", allowanceChargeList.ElementAt(5).Reason);
            Assert.AreEqual("VAT", allowanceChargeList.ElementAt(5).CategoryTradeTax.TypeCode);
            Assert.AreEqual("S", allowanceChargeList.ElementAt(5).CategoryTradeTax.CategoryCode);
            Assert.AreEqual(20.00, allowanceChargeList.ElementAt(5).CategoryTradeTax.RateApplicablePercent);

            Assert.IsTrue(allowanceChargeList.ElementAt(6).ChargeIndicator.Indicator);
            Assert.AreEqual(2.00, allowanceChargeList.ElementAt(6).CalculationPercent);
            Assert.AreEqual(100.00, allowanceChargeList.ElementAt(6).BasisAmount.Value);
            Assert.AreEqual(2.00, allowanceChargeList.ElementAt(6).ActualAmount.Value);
            Assert.AreEqual("FC", allowanceChargeList.ElementAt(6).ReasonCode);
            Assert.AreEqual("FRAIS DEPLACEMENT", allowanceChargeList.ElementAt(6).Reason);
            Assert.AreEqual("VAT", allowanceChargeList.ElementAt(6).CategoryTradeTax.TypeCode);
            Assert.AreEqual("K", allowanceChargeList.ElementAt(6).CategoryTradeTax.CategoryCode);
            Assert.AreEqual(0.00, allowanceChargeList.ElementAt(6).CategoryTradeTax.RateApplicablePercent);

            Assert.IsTrue(allowanceChargeList.ElementAt(7).ChargeIndicator.Indicator);
            Assert.AreEqual(1.00, allowanceChargeList.ElementAt(7).CalculationPercent);
            Assert.AreEqual(100.00, allowanceChargeList.ElementAt(7).BasisAmount.Value);
            Assert.AreEqual(1.00, allowanceChargeList.ElementAt(7).ActualAmount.Value);
            Assert.AreEqual("FC", allowanceChargeList.ElementAt(7).ReasonCode);
            Assert.AreEqual("FRAIS DEPLACEMENT", allowanceChargeList.ElementAt(7).Reason);
            Assert.AreEqual("VAT", allowanceChargeList.ElementAt(7).CategoryTradeTax.TypeCode);
            Assert.AreEqual("S", allowanceChargeList.ElementAt(7).CategoryTradeTax.CategoryCode);
            Assert.AreEqual(10.00, allowanceChargeList.ElementAt(7).CategoryTradeTax.RateApplicablePercent);
            ...
            Assert.AreEqual(4.90m, invoice.SupplyChainTradeTransaction.ApplicableHeaderTradeSettlement.SpecifiedTradeSettlementHeaderMonetarySummation.TaxTotalAmount.FirstOrDefault().Value);
            Assert.AreEqual("EUR", invoice.SupplyChainTradeTransaction.ApplicableHeaderTradeSettlement.SpecifiedTradeSettlementHeaderMonetarySummation.TaxTotalAmount.FirstOrDefault().CurrencyID);
        ...
        public void ExtractData_Facture_F20220024_Basic_SUCCESS()
        {
            ...
            Assert.IsTrue(line1.SpecifiedLineTradeSettlement.SpecifiedTradeAllowanceCharge.ElementAt(1).ChargeIndicator.Indicator);
            Assert.AreEqual(1.00, line1.SpecifiedLineTradeSettlement.SpecifiedTradeAllowanceCharge.ElementAt(1).ActualAmount.Value);
            Assert.AreEqual("ADL", line1.SpecifiedLineTradeSettlement.SpecifiedTradeAllowanceCharge.ElementAt(1).ReasonCode);
            ...
            Assert.AreEqual("123", invoice.SupplyChainTradeTransaction.ApplicableHeaderTradeSettlement.PayeeTradeParty.ID.FirstOrDefault().Value);
            ...
            Assert.AreEqual("FC", allowanceChargeList.ElementAt(1).ReasonCode);
        ...
        public void ExtractData_Facture_F20220025_Basic_SUCCESS()
        {
            ...
            Assert.IsNull(line2.SpecifiedLineTradeAgreement.NetPriceProductTradePrice.BasisQuantity);
        ...
        public void ExtractData_Facture_F20220030_Basic_SUCCESS()
        {
            ...
            Assert.AreEqual(0.0, line1.SpecifiedLineTradeSettlement.ApplicableTradeTax.RateApplicablePercent);
            ...
            Assert.AreEqual(0.0, line2.SpecifiedLineTradeSettlement.ApplicableTradeTax.RateApplicablePercent);
            ...
            Assert.AreEqual(0.0, line3.SpecifiedLineTradeSettlement.ApplicableTradeTax.RateApplicablePercent);
            ...
            Assert.AreEqual(1, invoice.SupplyChainTradeTransaction.ApplicableHeaderTradeAgreement.SellerTradeParty.ID.Count());
            Assert.AreEqual("123", invoice.SupplyChainTradeTransaction.ApplicableHeaderTradeAgreement.SellerTradeParty.ID.FirstOrDefault().Value);
            ...
            Assert.AreEqual("72", taxDistributionList.ElementAt(0).DueDateTypeCode);
            Assert.AreEqual(0.0, taxDistributionList.ElementAt(0).RateApplicablePercent);

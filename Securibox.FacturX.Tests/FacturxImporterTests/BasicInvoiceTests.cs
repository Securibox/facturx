    ...
    public class BasicInvoiceTests
    {
        ...
        public void ExtractData_Avoir_FR_type380_Basic_SUCCESS()
        {
            var importer = new FacturxImporter(
                Path.Combine(_mainDir, "Avoir_FR_type380_BASIC.pdf")
            );
            ...
            var invoice =
                crossIndustryInvoice as FacturX.SpecificationModels.Basic.CrossIndustryInvoice;
            ...
            Assert.That(
                invoice
                    ...
                    .ID
                    .Value,
                Is.EqualTo("urn:cen.eu:en16931:2017#compliant#urn:factur-x.eu:1p0:basic")
            );
        ...
        {
            var importer = new FacturxImporter(
                Path.Combine(_mainDir, "Avoir_FR_type381_BASIC.pdf")
            );
        ...
        [Test]
        public void ExtractData_Facture_F20260023_Basic_SUCCESS()
        {
            var importer = new FacturxImporter(
                Path.Combine(_mainDir, "Facture_F20260023-LE_FOURNISSEUR-POUR-LE_CLIENT_BASIC.pdf")
            );
            var crossIndustryInvoice = importer.ImportDataWithDeserialization();
            Assert.That(crossIndustryInvoice is not null);
            ...
            Assert.That(
                invoice
                    ?.SupplyChainTradeTransaction?.ApplicableHeaderTradeAgreement.SellerTradeParty.ID.FirstOrDefault()
                    ?.Value,
                Is.EqualTo("123")
            );
            ...
            Assert.That(
                invoice
                    ?.SupplyChainTradeTransaction?.ApplicableHeaderTradeDelivery.ShipToTradeParty.ID.FirstOrDefault()
                    ?.Value,
            ...
            var allowanceChargeList = invoice
                ?.SupplyChainTradeTransaction
                ?.ApplicableHeaderTradeSettlement
            ...
            Assert.That(
                allowanceChargeList?.ElementAt(0).CategoryTradeTax.TypeCode,
                Is.EqualTo("VAT")
            );
            Assert.That(
                allowanceChargeList?.ElementAt(0).CategoryTradeTax.CategoryCode,
                Is.EqualTo("S")
            );
            Assert.That(
                allowanceChargeList?.ElementAt(0).CategoryTradeTax.RateApplicablePercent,
                Is.EqualTo(20.00)
            );
            ...
            Assert.That(
                allowanceChargeList?.ElementAt(1).CategoryTradeTax.CategoryCode,
                Is.EqualTo("S")
            );
            Assert.That(
                allowanceChargeList?.ElementAt(1).CategoryTradeTax.RateApplicablePercent,
                Is.EqualTo(20.00)
            );
            ...
            Assert.That(
                allowanceChargeList?.ElementAt(2).CategoryTradeTax.TypeCode,
                Is.EqualTo("VAT")
            );
            Assert.That(
                allowanceChargeList?.ElementAt(2).CategoryTradeTax.CategoryCode,
                Is.EqualTo("S")
            );
            Assert.That(
                allowanceChargeList?.ElementAt(2).CategoryTradeTax.RateApplicablePercent,
                Is.EqualTo(20.00)
            );
            ...
            Assert.That(
                allowanceChargeList?.ElementAt(3).CategoryTradeTax.TypeCode,
                Is.EqualTo("VAT")
            );
            Assert.That(
                allowanceChargeList?.ElementAt(3).CategoryTradeTax.CategoryCode,
                Is.EqualTo("S")
            );
            Assert.That(
                allowanceChargeList?.ElementAt(3).CategoryTradeTax.RateApplicablePercent,
                Is.EqualTo(10.00)
            );
            ...
            Assert.That(
                allowanceChargeList?.ElementAt(4).CategoryTradeTax.TypeCode,
                Is.EqualTo("VAT")
            );
            Assert.That(
                allowanceChargeList?.ElementAt(4).CategoryTradeTax.CategoryCode,
                Is.EqualTo("S")
            );
            Assert.That(
                allowanceChargeList?.ElementAt(4).CategoryTradeTax.RateApplicablePercent,
                Is.EqualTo(20.00)
            );
            ...
            Assert.That(
                allowanceChargeList?.ElementAt(5).CategoryTradeTax.TypeCode,
                Is.EqualTo("VAT")
            );
            Assert.That(
                allowanceChargeList?.ElementAt(5).CategoryTradeTax.CategoryCode,
                Is.EqualTo("S")
            );
            Assert.That(
                allowanceChargeList?.ElementAt(5).CategoryTradeTax.RateApplicablePercent,
                Is.EqualTo(20.00)
            );
            ...
            Assert.That(
                allowanceChargeList?.ElementAt(6).CategoryTradeTax.TypeCode,
                Is.EqualTo("VAT")
            );
            Assert.That(
                allowanceChargeList?.ElementAt(6).CategoryTradeTax.CategoryCode,
                Is.EqualTo("K")
            );
            Assert.That(
                allowanceChargeList?.ElementAt(6).CategoryTradeTax.RateApplicablePercent,
                Is.EqualTo(0.00)
            );
            ...
            Assert.That(
                allowanceChargeList?.ElementAt(7).CategoryTradeTax.TypeCode,
                Is.EqualTo("VAT")
            );
            Assert.That(
                allowanceChargeList?.ElementAt(7).CategoryTradeTax.CategoryCode,
                Is.EqualTo("S")
            );
            Assert.That(
                allowanceChargeList?.ElementAt(7).CategoryTradeTax.RateApplicablePercent,
                Is.EqualTo(10.00)
            );
        ...
        [Test]
        public void ExtractData_Facture_F20260024_Basic_SUCCESS()
        {
            var importer = new FacturxImporter(
                Path.Combine(_mainDir, "Facture_F20260024-LE_FOURNISSEUR-POUR-LE_CLIENT_BASIC.pdf")
            );
            ...
            Assert.That(
                invoice
                    ?.SupplyChainTradeTransaction?.ApplicableHeaderTradeSettlement?.PayeeTradeParty.ID.FirstOrDefault()
                    ?.Value,
                Is.EqualTo("987")
            );
        ...
        [Test]
        public void ExtractData_Facture_F20260025_Basic_SUCCESS()
        {
            var importer = new FacturxImporter(
                Path.Combine(_mainDir, "Facture_F20260025-LE_FOURNISSEUR-POUR-LE_CLIENT_BASIC.pdf")
            );
            ...
            Assert.That(
                line2!.SpecifiedLineTradeAgreement.NetPriceProductTradePrice.BasisQuantity is null
            );
        ...
        [Test]
        public void ExtractData_Facture_F20260026_Basic_SUCCESS()
        {
            var importer = new FacturxImporter(
                Path.Combine(_mainDir, "Facture_F20260026-LE_FOURNISSEUR-POUR-LE_CLIENT_BASIC.pdf")
            );
        ...
        [Test]
        public void ExtractData_Facture_F20260027_Basic_SUCCESS()
        {
            var importer = new FacturxImporter(
                Path.Combine(_mainDir, "Facture_F20260027-LE_FOURNISSEUR-POUR-LE_CLIENT_BASIC.pdf")
            );
        ...
        [Test]
        public void ExtractData_Facture_F20260028_Basic_SUCCESS()
        {
            var importer = new FacturxImporter(
                Path.Combine(_mainDir, "Facture_F20260028-LE_FOURNISSEUR-POUR-LE_CLIENT_BASIC.pdf")
            );
        ...
        [Test]
        public void ExtractData_Facture_F20260029_Basic_SUCCESS()
        {
            var importer = new FacturxImporter(
                Path.Combine(_mainDir, "Facture_F20260029-LE_FOURNISSEUR-POUR-LE_CLIENT_BASIC.pdf")
            );
        ...
        [Test]
        public void ExtractData_Facture_F20260030_Basic_SUCCESS()
        {
            var importer = new FacturxImporter(
                Path.Combine(_mainDir, "Facture_F20260030-LE_FOURNISSEUR-POUR-LE_CLIENT_BASIC.pdf")
            );
            ...
            Assert.That(
                invoice?.SupplyChainTradeTransaction?.ApplicableHeaderTradeAgreement.SellerTradeParty.ID.Count(),
                Is.EqualTo(1)
            );
            Assert.That(
                invoice
        ...
        [Test]
        public void ExtractData_Facture_F20260031_Basic_SUCCESS()
        {
            var importer = new FacturxImporter(
                Path.Combine(_mainDir, "Facture_F20260031-LE_FOURNISSEUR-POUR-LE_CLIENT_BASIC.pdf")
            );

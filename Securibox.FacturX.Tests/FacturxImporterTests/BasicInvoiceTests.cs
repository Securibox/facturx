...
namespace Securibox.FacturX.Tests.FacturxImporterTests
{
    ...
    {
        private readonly string _mainDir = Path.Combine(System.IO.Directory.GetCurrentDirectory()?.Split("bin").First()!, "Invoices", "Basic");
        ...
        [Test]
        public void ExtractData_Avoir_FR_type380_Basic_SUCCESS()
        {
            var importer = new FacturxImporter(string.Format("{0}\\{1}", _mainDir, "Avoir_FR_type380_BASIC.pdf"));
            ...
            Assert.That(invoice?.ExchangedDocumentContext.GuidelineSpecifiedDocumentContextParameter.ID.Value, Is.EqualTo("urn:cen.eu:en16931:2017#compliant#urn:factur-x.eu:1p0:basic"));
        ...
        [Test]
        public void ExtractData_Avoir_FR_type381_Basic_SUCCESS()
        {
            var importer = new FacturxImporter(string.Format("{0}\\{1}", _mainDir, "Avoir_FR_type381_BASIC.pdf"));
        ...
        [Test]
        public void ExtractData_FACTURE_FR_Basic_SUCCESS()
        {
            var importer = new FacturxImporter(string.Format("{0}\\{1}", _mainDir, "Facture_FR_BASIC.pdf"));
            ...
            Assert.That(taxDistributionList!.ElementAt(1).DueDateTypeCode, Is.EqualTo("5"));
            Assert.That(taxDistributionList!.ElementAt(1).RateApplicablePercent, Is.EqualTo(5.50));
            Assert.That(taxDistributionList!.ElementAt(1).ExemptionReason is null);
        ...
        [Test]
        public void ExtractData_FACTURE_EU_Basic_SUCCESS()
        {
            var importer = new FacturxImporter(string.Format("{0}\\{1}", _mainDir, "Facture_UE_BASIC.pdf"));
        ...
        [Test]
        public void ExtractData_Facture_DOM_Basic_SUCCESS()
        {
            var importer = new FacturxImporter(string.Format("{0}\\{1}", _mainDir, "Facture_DOM_BASIC.pdf"));
        ...
        [Test]
        public void ExtractData_Facture_F20220023_Basic_SUCCESS()
        {
            var importer = new FacturxImporter(string.Format("{0}\\{1}", _mainDir, "Facture_F20220023-LE_FOURNISSEUR-POUR-LE_CLIENT_BASIC.pdf"));
            var crossIndustryInvoice = importer.ImportDataWithDeserialization();
            Assert.That(crossIndustryInvoice is not null);
            ...
            Assert.That(line1!.SpecifiedLineTradeSettlement.SpecifiedTradeAllowanceCharge.ElementAt(1).ChargeIndicator.Indicator is true);
            ...
            Assert.That(line1!.SpecifiedLineTradeSettlement.SpecifiedTradeAllowanceCharge.ElementAt(1).ReasonCode is null);
            Assert.That(line1!.SpecifiedLineTradeSettlement.SpecifiedTradeAllowanceCharge.ElementAt(1).Reason, Is.EqualTo("FRAIS PALETTE"));
            ...
            Assert.That(allowanceChargeList?.ElementAt(0).BasisAmount.Value, Is.EqualTo(100.00));
            Assert.That(allowanceChargeList?.ElementAt(0).ActualAmount.Value, Is.EqualTo(5.00));
            Assert.That(allowanceChargeList?.ElementAt(0).ReasonCode, Is.EqualTo("95"));
            ...
            Assert.That(allowanceChargeList?.ElementAt(1).CalculationPercent, Is.EqualTo(1.00));
            Assert.That(allowanceChargeList?.ElementAt(1).BasisAmount.Value, Is.EqualTo(100.00));
            Assert.That(allowanceChargeList?.ElementAt(1).ActualAmount.Value, Is.EqualTo(1.00));
            ...
            Assert.That(allowanceChargeList?.ElementAt(2).ChargeIndicator.Indicator is false);
            Assert.That(allowanceChargeList?.ElementAt(2).CalculationPercent, Is.EqualTo(1.00));
            Assert.That(allowanceChargeList?.ElementAt(2).BasisAmount.Value, Is.EqualTo(100.00));
            Assert.That(allowanceChargeList?.ElementAt(2).ReasonCode, Is.EqualTo("100"));
            Assert.That(allowanceChargeList?.ElementAt(2).Reason, Is.EqualTo("REMISE COMMERCIALE"));
            ...
            Assert.That(allowanceChargeList?.ElementAt(3).ChargeIndicator.Indicator is false);
            Assert.That(allowanceChargeList?.ElementAt(3).CalculationPercent, Is.EqualTo(2.00));
            Assert.That(allowanceChargeList?.ElementAt(3).BasisAmount.Value, Is.EqualTo(100.00));
            Assert.That(allowanceChargeList?.ElementAt(3).ActualAmount.Value, Is.EqualTo(2.00));
            Assert.That(allowanceChargeList?.ElementAt(3).ReasonCode is null);
            Assert.That(allowanceChargeList?.ElementAt(3).Reason, Is.EqualTo("REMISE COMMERCIALE"));
            ...
            Assert.That(allowanceChargeList?.ElementAt(4).ChargeIndicator.Indicator is true);
            Assert.That(allowanceChargeList?.ElementAt(4).CalculationPercent, Is.EqualTo(10.00));
            Assert.That(allowanceChargeList?.ElementAt(4).BasisAmount.Value, Is.EqualTo(100.00));
            Assert.That(allowanceChargeList?.ElementAt(4).ActualAmount.Value, Is.EqualTo(10.00));
            Assert.That(allowanceChargeList?.ElementAt(4).ReasonCode, Is.EqualTo("FC"));
            Assert.That(allowanceChargeList?.ElementAt(4).Reason, Is.EqualTo("FRAIS DEPLACEMENT"));
            Assert.That(allowanceChargeList?.ElementAt(4).CategoryTradeTax.TypeCode, Is.EqualTo("VAT"));
            Assert.That(allowanceChargeList?.ElementAt(4).CategoryTradeTax.CategoryCode, Is.EqualTo("S"));
            Assert.That(allowanceChargeList?.ElementAt(4).CategoryTradeTax.RateApplicablePercent, Is.EqualTo(20.00));

            Assert.That(allowanceChargeList?.ElementAt(5).ChargeIndicator.Indicator is true);
            Assert.That(allowanceChargeList?.ElementAt(5).CalculationPercent, Is.EqualTo(1.00));
            Assert.That(allowanceChargeList?.ElementAt(5).BasisAmount.Value, Is.EqualTo(100.00));
            Assert.That(allowanceChargeList?.ElementAt(5).ActualAmount.Value, Is.EqualTo(1.00));
            Assert.That(allowanceChargeList?.ElementAt(5).ReasonCode, Is.EqualTo("ADR"));
            Assert.That(allowanceChargeList?.ElementAt(5).Reason, Is.EqualTo("FRAIS DEPLACEMENT"));
            Assert.That(allowanceChargeList?.ElementAt(5).CategoryTradeTax.TypeCode, Is.EqualTo("VAT"));
            Assert.That(allowanceChargeList?.ElementAt(5).CategoryTradeTax.CategoryCode, Is.EqualTo("S"));
            Assert.That(allowanceChargeList?.ElementAt(5).CategoryTradeTax.RateApplicablePercent, Is.EqualTo(20.00));

            Assert.That(allowanceChargeList?.ElementAt(6).ChargeIndicator.Indicator is true);
            Assert.That(allowanceChargeList?.ElementAt(6).CalculationPercent, Is.EqualTo(2.00));
            Assert.That(allowanceChargeList?.ElementAt(6).BasisAmount.Value, Is.EqualTo(100.00));
            Assert.That(allowanceChargeList?.ElementAt(6).ActualAmount.Value, Is.EqualTo(2.00));
            Assert.That(allowanceChargeList?.ElementAt(6).ReasonCode, Is.EqualTo("FC"));
            Assert.That(allowanceChargeList?.ElementAt(6).Reason, Is.EqualTo("FRAIS DEPLACEMENT"));
            Assert.That(allowanceChargeList?.ElementAt(6).CategoryTradeTax.TypeCode, Is.EqualTo("VAT"));
            Assert.That(allowanceChargeList?.ElementAt(6).CategoryTradeTax.CategoryCode, Is.EqualTo("K"));
            Assert.That(allowanceChargeList?.ElementAt(6).CategoryTradeTax.RateApplicablePercent, Is.EqualTo(0.00));

            Assert.That(allowanceChargeList?.ElementAt(7).ChargeIndicator.Indicator is true);
            Assert.That(allowanceChargeList?.ElementAt(7).CalculationPercent, Is.EqualTo(1.00));
            Assert.That(allowanceChargeList?.ElementAt(7).BasisAmount.Value, Is.EqualTo(100.00));
            Assert.That(allowanceChargeList?.ElementAt(7).ActualAmount.Value, Is.EqualTo(1.00));
            Assert.That(allowanceChargeList?.ElementAt(7).ReasonCode, Is.EqualTo("FC"));
            Assert.That(allowanceChargeList?.ElementAt(7).Reason, Is.EqualTo("FRAIS DEPLACEMENT"));
            Assert.That(allowanceChargeList?.ElementAt(7).CategoryTradeTax.TypeCode, Is.EqualTo("VAT"));
            Assert.That(allowanceChargeList?.ElementAt(7).CategoryTradeTax.CategoryCode, Is.EqualTo("S"));
            Assert.That(allowanceChargeList?.ElementAt(7).CategoryTradeTax.RateApplicablePercent, Is.EqualTo(10.00));
            ...
            Assert.That(invoice?.SupplyChainTradeTransaction?.ApplicableHeaderTradeSettlement?.SpecifiedTradeSettlementHeaderMonetarySummation?.TaxTotalAmount?.FirstOrDefault()?.Value, Is.EqualTo(4.90m));
            Assert.That(invoice?.SupplyChainTradeTransaction?.ApplicableHeaderTradeSettlement?.SpecifiedTradeSettlementHeaderMonetarySummation?.TaxTotalAmount?.FirstOrDefault()?.CurrencyID, Is.EqualTo("EUR"));
        ...
        [Test]
        public void ExtractData_Facture_F20220024_Basic_SUCCESS()
        {
            var importer = new FacturxImporter(string.Format("{0}\\{1}", _mainDir, "Facture_F20220024-LE_FOURNISSEUR-POUR-LE_CLIENT_BASIC.pdf"));
            ...
            Assert.That(line1!.SpecifiedLineTradeSettlement.SpecifiedTradeAllowanceCharge.ElementAt(1).ChargeIndicator.Indicator is true);
            Assert.That(line1!.SpecifiedLineTradeSettlement.SpecifiedTradeAllowanceCharge.ElementAt(1).ActualAmount.Value, Is.EqualTo(1.00));
            Assert.That(line1!.SpecifiedLineTradeSettlement.SpecifiedTradeAllowanceCharge.ElementAt(1).ReasonCode, Is.EqualTo("ADL"));
            ...
            Assert.That(invoice?.SupplyChainTradeTransaction?.ApplicableHeaderTradeSettlement?.PayeeTradeParty.ID.FirstOrDefault()?.Value, Is.EqualTo("123"));
            ...
            Assert.That(allowanceChargeList?.ElementAt(1).ReasonCode, Is.EqualTo("FC"));
        ...
        [Test]
        public void ExtractData_Facture_F20220025_Basic_SUCCESS()
        {
            var importer = new FacturxImporter(string.Format("{0}\\{1}", _mainDir, "Facture_F20220025-LE_FOURNISSEUR-POUR-LE_CLIENT_BASIC.pdf"));
            ...
            Assert.That(line2!.SpecifiedLineTradeAgreement.NetPriceProductTradePrice.BasisQuantity is null);
        ...
        [Test]
        public void ExtractData_Facture_F20220026_Basic_SUCCESS()
        {
            var importer = new FacturxImporter(string.Format("{0}\\{1}", _mainDir, "Facture_F20220026-LE_FOURNISSEUR-POUR-LE_CLIENT_BASIC.pdf"));
        ...
        [Test]
        public void ExtractData_Facture_F20220027_Basic_SUCCESS()
        {
            var importer = new FacturxImporter(string.Format("{0}\\{1}", _mainDir, "Facture_F20220027-LE_FOURNISSEUR-POUR-LE_CLIENT_BASIC.pdf"));
        ...
        [Test]
        public void ExtractData_Facture_F20220028_Basic_SUCCESS()
        {
            var importer = new FacturxImporter(string.Format("{0}\\{1}", _mainDir, "Facture_F20220028-LE_FOURNISSEUR-POUR-LE_CLIENT_BASIC.pdf"));
        ...
        [Test]
        public void ExtractData_Facture_F20220029_Basic_SUCCESS()
        {
            var importer = new FacturxImporter(string.Format("{0}\\{1}", _mainDir, "Facture_F20220029-LE_FOURNISSEUR-POUR-LE_CLIENT_BASIC.pdf"));
        ...
        [Test]
        public void ExtractData_Facture_F20220030_Basic_SUCCESS()
        {
            var importer = new FacturxImporter(string.Format("{0}\\{1}", _mainDir, "Facture_F20220030-LE_FOURNISSEUR-POUR-LE_CLIENT_BASIC.pdf"));
            ...
            Assert.That(line1!.SpecifiedLineTradeSettlement.ApplicableTradeTax.RateApplicablePercent, Is.EqualTo(0.0));
            ...
            Assert.That(line2!.SpecifiedLineTradeSettlement.ApplicableTradeTax.RateApplicablePercent, Is.EqualTo(0.0));
            ...
            Assert.That(line3!.SpecifiedLineTradeSettlement.ApplicableTradeTax.RateApplicablePercent, Is.EqualTo(0.0));
            ...
            Assert.That(invoice?.SupplyChainTradeTransaction?.ApplicableHeaderTradeAgreement.SellerTradeParty.ID.Count(), Is.EqualTo(1));
            Assert.That(invoice?.SupplyChainTradeTransaction?.ApplicableHeaderTradeAgreement.SellerTradeParty.ID.FirstOrDefault()?.Value, Is.EqualTo("123"));
            ...
            Assert.That(taxDistributionList!.ElementAt(0).DueDateTypeCode, Is.EqualTo("72"));
            Assert.That(taxDistributionList!.ElementAt(0).RateApplicablePercent, Is.EqualTo(0.0));
        ...
        [Test]
        public void ExtractData_Facture_F20220031_Basic_SUCCESS()
        {
            var importer = new FacturxImporter(string.Format("{0}\\{1}", _mainDir, "Facture_F20220031-LE_FOURNISSEUR-POUR-LE_CLIENT_BASIC.pdf"));

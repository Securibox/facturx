...
namespace Securibox.FacturX.Tests.FacturxImporterTests
{
    public class BasicWLInvoiceTests
    {
        ...
        public void ExtractData_Facture_FR_BASICWL_SUCCESS()
        {
            ...
            var invoice =
                crossIndustryInvoice as FacturX.SpecificationModels.BasicWL.CrossIndustryInvoice;
            ...
            Assert.That(
                invoice?.ExchangedDocument.IncludedNote.First().Content,
            ...
            Assert.That(
                invoice
                    ...
                    .ID
                    .Value,
                Is.EqualTo("urn:factur-x.eu:1p0:basicwl")
            );
        ...
        [Test]
        public void ExtractData_Facture_F20260023_BASICWL_SUCCESS()
        {
            var importer = new FacturxImporter(
                Path.Combine(
                    _mainDir,
                    "Facture_F20260023-LE_FOURNISSEUR-POUR-LE_CLIENT_BASIC_WL.pdf"
                )
            );
            ...
            Assert.That(
                invoice
                    ?.SupplyChainTradeTransaction?.ApplicableHeaderTradeAgreement.SellerTradeParty.ID.ElementAtOrDefault(
                        0
                    )
                    ?.Value,
                Is.EqualTo("123")
            ...
            Assert.That(
                invoice
                    ?.SupplyChainTradeTransaction?.ApplicableHeaderTradeAgreement.BuyerTradeParty.GlobalID.ElementAtOrDefault(
                        0
                    )
                    ?.Value,
            ...
            Assert.That(
                invoice
                    ?.SupplyChainTradeTransaction?.ApplicableHeaderTradeDelivery.ShipToTradeParty.ID.ElementAt(
                        0
                    )
                    .Value,
            ...
            Assert.That(
                invoice
                    ?.SupplyChainTradeTransaction?.ApplicableHeaderTradeSettlement?.PayeeTradeParty.GlobalID.ElementAtOrDefault(
                        0
                    )
                    ?.Value,
            ...
            Assert.That(
                invoice
                    ?.SupplyChainTradeTransaction?.ApplicableHeaderTradeSettlement?.SpecifiedTradeSettlementHeaderMonetarySummation?.TaxTotalAmount.ElementAtOrDefault(
                        0
                    )
                    ?.Value,
                Is.EqualTo(4.90m)
            ...
            Assert.That(
                invoice
                    ?.SupplyChainTradeTransaction?.ApplicableHeaderTradeSettlement?.InvoiceReferencedDocument.ElementAtOrDefault(
                        0
                    )
        ...
        [Test]
        public void ExtractData_Facture_F20260024_BASICWL_SUCCESS()
        {
            var importer = new FacturxImporter(
                Path.Combine(
                    _mainDir,
                    "Facture_F20260024-LE_FOURNISSEUR-POUR-LE_CLIENT_BASIC_WL.pdf"
                )
            );
            ...
            Assert.That(
                invoice
                    ?.SupplyChainTradeTransaction?.ApplicableHeaderTradeAgreement.BuyerTradeParty.GlobalID.ElementAt(
                        0
                    )
                    .Value,
                Is.EqualTo("3654789851")
            ...
            Assert.That(
                invoice
                    ?.SupplyChainTradeTransaction?.ApplicableHeaderTradeSettlement?.PayeeTradeParty.ID.ElementAtOrDefault(
                        0
                    )
                    ?.Value,
                Is.EqualTo("987")
        ...
        [Test]
        public void ExtractData_Facture_F20260025_BASICWL_SUCCESS()
        {
            var importer = new FacturxImporter(
                Path.Combine(
                    _mainDir,
                    "Facture_F20260025-LE_FOURNISSEUR-POUR-LE_CLIENT_BASIC_WL.pdf"
                )
            );
        ...
        [Test]
        public void ExtractData_Facture_F20260026_BASICWL_SUCCESS()
        {
            var importer = new FacturxImporter(
                Path.Combine(
                    _mainDir,
                    "Facture_F20260026-LE_FOURNISSEUR-POUR-LE_CLIENT_BASIC_WL.pdf"
                )
            );
        ...
        [Test]
        public void ExtractData_Facture_F20260027_BASICWL_SUCCESS()
        {
            var importer = new FacturxImporter(
                Path.Combine(
                    _mainDir,
                    "Facture_F20260027-LE_FOURNISSEUR-POUR-LE_CLIENT_BASIC_WL.pdf"
                )
            );
            ...
            Assert.That(
                invoice
                    ?.SupplyChainTradeTransaction?.ApplicableHeaderTradeAgreement.SellerTradeParty.GlobalID.ElementAtOrDefault(
                        0
                    )
                    ?.Value,
                Is.EqualTo("587451236587")
        ...
        public void ExtractData_Facture_F20260028_BASICWL_SUCCESS()
        {
            var importer = new FacturxImporter(
                Path.Combine(
                    _mainDir,
                    "Facture_F20260028-LE_FOURNISSEUR-POUR-LE_CLIENT_BASIC_WL.pdf"
                )
            );
        ...
        [Test]
        public void ExtractData_Facture_F20260029_BASICWL_SUCCESS()
        {
            var importer = new FacturxImporter(
                Path.Combine(
                    _mainDir,
                    "Facture_F20260029-LE_FOURNISSEUR-POUR-LE_CLIENT_BASIC_WL.pdf"
                )
            );
            ...
            Assert.That(
                invoice
                    ?.SupplyChainTradeTransaction?.ApplicableHeaderTradeDelivery.ShipToTradeParty.GlobalID.ElementAtOrDefault(
                        0
                    )
                    ?.Value,
                Is.EqualTo("3654789851")
        ...
        [Test]
        public void ExtractData_Facture_F20260030_BASICWL_SUCCESS()
        {
            var importer = new FacturxImporter(
                Path.Combine(
                    _mainDir,
                    "Facture_F20260030-LE_FOURNISSEUR-POUR-LE_CLIENT_BASIC_WL.pdf"
                )
            );
        ...
        [Test]
        public void ExtractData_Facture_F20260031_BASIC_WL_SUCCESS()
        {
            var importer = new FacturxImporter(
                Path.Combine(
                    _mainDir,
                    "Facture_F20260031-LE_FOURNISSEUR-POUR-LE_CLIENT_BASIC_WL.pdf"
                )
            );
        ...
        {
            var importer = new FacturxImporter(
                Path.Combine(_mainDir, "Avoir_FR_type380_BASICWL.pdf")
            );
            ...
            Assert.That(
                invoice?.SupplyChainTradeTransaction?.ApplicableHeaderTradeDelivery is not null
            );
            Assert.That(
                invoice
                    ?.SupplyChainTradeTransaction
        ...
        {
            var importer = new FacturxImporter(
                Path.Combine(_mainDir, "Avoir_FR_type381_BASICWL.pdf")
            );

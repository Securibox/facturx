...
namespace Securibox.FacturX.Tests.FacturxImporterTests
{
    public class ExtendedInvoiceTests
    {
        ...
        public void ExtractData_Facture_F20220025_Extended_SUCCESS()
        {
            ...
            Assert.That(invoice?.SupplyChainTradeTransaction?.ApplicableHeaderTradeSettlement?.SpecifiedTradeSettlementPaymentMeans?.PayeeSpecifiedCreditorFinancialInstitution is null);

...
namespace Securibox.FacturX.Tests.FacturxImporterTests
{
    ...
    {
        private readonly string _mainDir = Path.Combine(System.IO.Directory.GetCurrentDirectory(), "Invoices", "Extended");
        ...
        public void ExtractData_Avoir_FR_type380_SUCCESS()
        {
            ...
            Assert.That(invoice?.ExchangedDocumentContext.GuidelineSpecifiedDocumentContextParameter.ID.Value, Is.EqualTo("urn:cen.eu:en16931:2017#conformant#urn:factur-x.eu:1p0:extended"));
            ...
            Assert.That(line1?.SpecifiedLineTradeAgreement.GrossPriceProductTradePrice.AppliedTradeAllowanceCharge.BasisAmount is null);
        ...
        public void ExtractData_FACTURE_FR_type380_SUCCESS()
        {
            ...
            Assert.That(taxDistributionList!.ElementAt(1).ExemptionReasonCode is null);
        ...
        public void ExtractData_Facture_F20220023_Extended_SUCCESS()
        {
            ...
            Assert.That(invoice?.SupplyChainTradeTransaction?.ApplicableHeaderTradeAgreement?.SellerTradeParty?.ID, Is.EqualTo("123"));
            ...
            Assert.That(invoice?.SupplyChainTradeTransaction?.ApplicableHeaderTradeDelivery.ShipToTradeParty.ID, Is.EqualTo("PRIVATE_ID_DEL"));
        ...
        public void ExtractData_Facture_F20220024_Extended_SUCCESS()
        {
            ...
            Assert.That(invoice?.SupplyChainTradeTransaction?.ApplicableHeaderTradeSettlement?.PayeeTradeParty.ID, Is.EqualTo("123"));
        ...
        public void ExtractData_Facture_F20220025_Extended_SUCCESS()
        {
            ...
            Assert.That(invoice?.SupplyChainTradeTransaction?.ApplicableHeaderTradeSettlement?.SpecifiedTradeSettlementPaymentMeans?.ElementAt(0).PayeeSpecifiedCreditorFinancialInstitution is null);
